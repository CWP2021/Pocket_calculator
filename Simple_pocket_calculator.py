#Description: A simple pocket calculator that can perform basic arithmetical operations. It will warn the user if they want to divide by zero or if they type in invalid values.
